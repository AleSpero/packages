...
public class Messages {
  ...
  public interface InAppPurchaseApi {
    ...
    /** Wraps BillingClient#isAlternativeBillingOnlyAvailableAsync(). */
    void isExternalOfferAvailableAsync(@NonNull Result<PlatformBillingResult> result);
    /** Wraps BillingClient#showAlternativeBillingOnlyInformationDialog(). */
    void showExternalOfferInformationDialog(@NonNull Result<PlatformBillingResult> result);
    /** Wraps BillingClient#createAlternativeBillingOnlyReportingDetailsAsync(AlternativeBillingOnlyReportingDetailsListener). */
    void createExternalOfferReportingDetailsAsync(@NonNull Result<PlatformAlternativeBillingOnlyReportingDetailsResponse> result);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable InAppPurchaseApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.in_app_purchase_android.InAppPurchaseApi.isExternalOfferAvailableAsync" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.isExternalOfferAvailableAsync(resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.in_app_purchase_android.InAppPurchaseApi.showExternalOfferInformationDialog" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.showExternalOfferInformationDialog(resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.in_app_purchase_android.InAppPurchaseApi.createExternalOfferReportingDetailsAsync" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.createExternalOfferReportingDetailsAsync(resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
